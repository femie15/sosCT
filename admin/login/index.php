...
<body>
  ...
  <?php
	...
	<!--<div class="header">-->
	     <div class="headerx">
			<div>EDUmix <span>e-Test</span></div>
		...
		<form action="#" method="post">
		  <?php if(isset($_SESSION['stdname'])){
                          header('Location:../admwelcome.php');}else{  
                          /***************************** Step 2 ****************************/
                        } ?>
						
				<input type="text" placeholder="username" name="name"><br>
				<input type="password" placeholder="password" name="password"><br>
				<input type="submit" name="stdsubmit" value="Admin Login">
		</form>
		</div>
...
<footer class="footer">
&copy; 2019 OYO STATE MINISTRY OF EDUCATION,SCIENCE AND TECHNOLOGY &emsp;
</footer>
</html>