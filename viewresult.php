                ...
                <div class="page">
                        ...
                        if(isset($_REQUEST['details'])) {
                            ...
                            if(mysqli_num_rows($result)!=0) {
                                ...
                                ?>
								<br/><br/>
                    <table cellpadding="5px" align="center" width="60%" cellspacing="0" border="0.5px" style="background:#e0e0e0 url(images/page.gif);margin-left:250px; text-align:left; line-height:20px;margin-bottom:5px;">
                        <tr>
                            <td colspan="2" style="margin-bottom:-35px;"><h4 style="color:#1111ff;text-align:center;"><span style="color:#aa11ff; font-size:30px; text-transform:uppercase;"><?php echo htmlspecialchars_decode($r['stdname'],ENT_QUOTES); ?></span> &emsp;Test Result</h4></td>
                        </tr>
                        
                        <tr>
                            <td>Student Name</td>
                            <td>
	<?php echo htmlspecialchars_decode($r['stdname'],ENT_QUOTES); ?></td>
                        </tr>
                        <tr>
                            <td>Test</td>
                            <td>
	<?php echo htmlspecialchars_decode($r['testname'],ENT_QUOTES); ?></td>
                        </tr>
                        <tr>
                            <td>Subject</td>
                            <td>
	<?php echo htmlspecialchars_decode($r['subname'],ENT_QUOTES); ?></td>
                        </tr>
                        <tr>
                            <td>Date and Time</td>
                            <td>
	...
	<?php echo (($r['om']/$r['tm'])*100)." %"; ?></td>
                            ...
                            <td colspan="2" ><hr style="color:#ff0000;border-width:1px; "/><span onclick="window.print()" style="cursor:pointer; color: blue; "><center>Print this Result</center></span></td>
                                ...
                                if(mysqli_num_rows($result1)==0) {
                                    ...
                                    ?>
								<br/><br/>	
                    <table cellpadding="10" cellspacing="2px" border="2" class="datatable">
                        <tr>
                            <th>Q. No</th>
                            <th>Question</th>
                        ...
                        <tr>
                            <td>
	<?php echo $r1['questionid']; ?></td>
                            <td>
	<?php echo htmlspecialchars_decode($r1['quest'],ENT_QUOTES); ?></td>
                            <td>
	<?php echo htmlspecialchars_decode($r2['corans'],ENT_QUOTES); ?></td>
                            <td>
	<?php echo htmlspecialchars_decode($r2['stdans'],ENT_QUOTES); ?></td>
                            <td>
	<?php echo $r2['stdmarks']; ?></td>
                                                    <?php
                                                    if($r2['stdmarks']==0) {
