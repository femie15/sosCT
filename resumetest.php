...
<html>
    <head>
        <title>e-Test | Resume Test</title>
...
?>
        <div id="container">
            <div class="header">
               <img style="margin:10px 2px 2px 10px;float:left;" height="80" width="200" src="images/logo.gif" alt="OYO e-Test"/><h4 style="color:#ffff00;text-align:center;margin:20px 10px 5px 5px;">
               <center><br>
...
// Navigations
    ...
    ?>
                    ...
                    <table cellpadding="30" cellspacing="10" align="center">
                        ...
                        <tr>
                            <td colspan="3">
                                <input type="submit" tabindex="3" value="Resume Exam" name="resumetest" class="subbtn" />
                            </td>
                        </tr>
                    </table>
    ...
    <?php
        ...
        if(mysqli_num_rows($result)==0) {
            echo"<br/><br/><br/><br/><br/><br/><h3 style=\"color:#0000cc;text-align:center;\">There are no incomplete exams, that needs to be resumed! Please Try Again..!</h3>";
        }
        else {
        //editing components
            ?><br/><br/>
